...
const AddPet = () => {
    ...
    // Component mount olduğunda species'leri çek
    useEffect(() => {
        fetchSpecies();
    }, []);
    ...
    const handleInputChange = (e) => {
        ...
        try {
            ...
            const response = await petService.createMyPet(petData);
            ...
            if (response.success) {
                ...
                setError(response.message || 'Pet eklenirken hata oluştu.');
            }
        } catch (error) {
            console.error('Pet ekleme hatası:', error);
            setError('Pet eklenirken bir hata oluştu. Lütfen tekrar deneyin.');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="add-pet">
            <div className="page-header">
                <h1>Yeni Pet Ekle</h1>
                <p>Pet'inizin bilgilerini doldurun</p>
            </div>
